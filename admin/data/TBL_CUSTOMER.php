...
class TBL_CUSTOMER {
	...
	public function edit($user_id,$fname,$lname,$email_id,$mobile,$is_active,$sex,$profile_pic,$username,$password,$phone,$comp_apt,$add1,$add2,$city,$state,$country, $created_on, $web_id){
		$mysqli = Configuration::mysqli_configation();
