 ...
 <div class="form-group">
  ...
  <div class="col-md-9 col-sm-9 col-xs-12">
      <select class="select2_multiple form-control" multiple="multiple">
          ...
          <option>Laundry Products</option>
          <option>Laundry Products > Combo Washer Dryer</option>
          <option>Laundry Products > Washer </option>
          <option>Laundry Products > Dryer </option>
          <option>Laundry Products > Stackable Set </option>
          <option>Laundry Products > Accessories </option>
          <option>Dishwashers</option>
          <option>Refrigerators</option>
          <option>Freezers</option>
          <option>Wine Coolers</option>
          <option>Can Coolers</option>
          <option>Range Hoods</option>
      </select>
  </div>
</div>
<div class="form-group">
 ...
 <div class="form-group">
    ...
    <div class="col-md-9 col-sm-9 col-xs-12">
       <div class="radio-inline">
            <label>
                <input type="radio" checked="" value="option1" id="optionsRadios1" name="ProductStatus"> Active
            </label>
        </div>

        <div class="radio-inline">
            <label>
                <input type="radio" checked="" value="option1" id="optionsRadios1" name="ProductStatus"> In Active
            </label>
        </div>
    </div>
</div>
...
<div class="form-group">
   ...
   <div class="col-md-9 col-sm-9 col-xs-12">                                                
      <textarea placeholder="This will be a HTML Editor" class="form-control" name="message" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100" data-parsley-minlength-message="Come on! You need to enter at least a 20 caracters long comment.." data-parsley-validation-threshold="10"></textarea>
   </div>
</div>
<div class="form-group">
