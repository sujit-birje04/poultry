...
class CI_Email {
    ...
    var	$smtp_user	 = "sujit.teccron@gmail.com";	 // SMTP Username
    var	$smtp_pass	 = "sujit@123";	 // SMTP Password
    /*
	var	$protocol	 = "mail";	// mail/sendmail/smtp
	var	$smtp_host	 = "mail.darbarwebs.com";//"ssl://smtp.gmail.com";	 // SMTP Server.  Example: mail.earthlink.net
    var	$smtp_user	 = "test@darbarwebs.com";//"sujit.teccron@gmail.com";	 // SMTP Username
    var	$smtp_pass	 = "Test123$";//sujit@123";	 // SMTP Password
    */
