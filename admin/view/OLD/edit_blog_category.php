...
<?php
        ...
        $objBlog = new TBL_ARTICLE_CATEGORY();
        $mainObj = $objBlog->getdetails($id);
        $details = $mainObj;
?>
   <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_title">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 pull-right text-right">                            
                              ...
                              <button type="button" frm_id="frm_country" call_link="<?=SERVER_PATH?>controller/controller.php?method=editblogcategory-API&is_close=0" 
                                      name="btn_save" class="btn btn-success save_show_message" >Save</button>

                              <button type="button" frm_id="frm_country" call_link="<?=SERVER_PATH?>controller/controller.php?method=editblogcategory-API&is_close=1"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input name="ac_id" type="hidden" value="<?=$details['ac_id']?>" >
                                    <input name="description" type="hidden" value="<?=$details['description']?>" >
                                    <input type="text" value="<?=$details['title']?>" name="title" required="required" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            <div class="form-group">
