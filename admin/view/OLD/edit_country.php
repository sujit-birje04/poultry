                    ...
                    <div class="x_title">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 pull-right text-right">                            
                              ...
                              <button type="button" frm_id="frm_country" call_link="<?=SERVER_PATH?>controller/controller.php?method=editcountry-API&is_close=0" 
                                      name="btn_save" class="btn btn-success save_show_message" >Save</button>

                              <button type="button" frm_id="frm_country" call_link="<?=SERVER_PATH?>controller/controller.php?method=editcountry-API&is_close=1"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input name="country_id" type="hidden" value="<?=$details['country_id']?>" >
