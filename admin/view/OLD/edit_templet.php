                    ...
                    <div class="x_title">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 pull-right text-right">                            
                              ...
                              <button type="button" frm_id="frm_menu" call_link="<?=SERVER_PATH?>controller/controller.php?method=edittemplate-API&is_close=0" 
                                      name="btn_save" class="btn btn-success save_show_message" >Save</button>

                              <button type="button" frm_id="frm_menu" call_link="<?=SERVER_PATH?>controller/controller.php?method=edittemplate-API&is_close=1"
                                      name="btn_save_close" id="btn_save_close" class="btn btn-warning btn_save_close">Save & Close</button>
                              <button type="button" name="btn_cancel" id="btn_cancel" class="btn btn-primary"  call_url="<?=SERVER_PATH?>view/manage_templet.php" >Cancel</button>        
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input name="t_id" type="hidden" value="<?=$details['t_id']?>" >
