                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                            <td>
                                              <a class="btn btn-info btn-xs" href="<?=SERVER_PATH?>view/edit_country.php?id=<?=$arr_value['country_id']?>" ><i class="fa fa-edit"></i> Edit </a>          
                                              <a href="#" class="btn btn-danger btn-xs btn_delete" call_link="<?=SERVER_PATH?>controller/controller.php?method=deletecountry-API&id=<?=$arr_value['country_id']?>" ><i class="fa fa-trash-o"></i> Delete </a>              
                                            </td>
                                        </tr>
                                        <?php
                                        }
                                    ...
                                    <tfoot>
                                        <tr>
                                          ...
                                          <th>
                                            <button type="button" frm_id="frm_country" call_link="<?=SERVER_PATH?>controller/controller.php?method=insertcountry-API&is_close=1"
