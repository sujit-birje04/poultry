...
<div class="right_col" role="main">
   ...
   <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <form id="frm_form" name="frm_form" data-parsley-validate class="form-horizontal form-label-left">
                    <div class="x_title">
                        <h2>Manage Form</h2>
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                            <td>
                                              <a class="btn btn-info btn-xs" href="<?=SERVER_PATH?>view/edit_form.php?id=<?=$arr_value['f_id']?>" ><i class="fa fa-edit"></i> Edit </a>          
                                              <a href="#" class="btn btn-danger btn-xs btn_delete" call_link="<?=SERVER_PATH?>controller/controller.php?method=deletetemplet-API&id=<?=$arr_value['f_id']?>" ><i class="fa fa-trash-o"></i> Delete </a>              
                                            </td>
                                        </tr>
                                        <?php
                                        }
                                    ...
                                    <tfoot>
                                        <tr>
                                          ...
                                          <th>
                                            <button type="button" frm_id="frm_form" call_link="<?=SERVER_PATH?>controller/controller.php?method=insertform-API&is_close=1"
