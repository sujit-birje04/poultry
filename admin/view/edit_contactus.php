                        ...
                        <h2>Message : <?=$id?></h2>
                         <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 pull-right text-right">
                                ...
                                -->
                                <button  call_url="<?=SERVER_PATH?>view/manage_contactus.php" type="button" name="btn_cancel" id="btn_cancel" class="btn btn-primary">Back</button>                                       
                            </div>
                        </div>
                    ...
                    <div class="x_content">                       
                        <div class="col-md-9">
                            ...
                            <div class="form-group">
                                ...
                                <label class="control-label" ><?=$details['phone']?></label>
                            </div>
                            <div class="form-group">
