                      ...
                      <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="general-tab">
                          <div class="col-md-6">
                              <h2>Personal Details</h2>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" >Joined date </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="hidden" value="<?=$details['web_id']?>" name="web_id" class="form-control">
                                        <input type="text" value="<?=date('m/d/Y', strtotime($details["created_on"]))?>" name="created_on" class="form-control col-md-7 col-xs-12 date_picker">
                                    </div>
                                </div>
