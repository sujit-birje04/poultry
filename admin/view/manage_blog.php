            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            ?>
                                     <tr>                                               
                                        <td><?=($page_lower+1)?></td>
                                        <td><?=$arr_value['blog_id']?></td>
                                        <td><?=$arr_value['title']?></td>
                                        <td><?=$arr_value['html_short']?></td>
                                        <td><?=$arr_value['created_on']?></td>
                                        <td><?=$arr_value['sort_code']?></td>
                                        <?php
                                        ...
                                        ?>
                                        <td>
                                            <a href="<?=SERVER_PATH?>view/edit_blog.php?id=<?=$arr_value['blog_id']?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                                            <a href="#" class="btn btn-danger btn-xs btn_delete" call_link="<?=SERVER_PATH?>controller/controller.php?method=deleteblog-API&id=<?php echo $arr_value['blog_id']; ?>" ><i class="fa fa-trash-o"></i> Delete </a>
                                        </td>
                                    </tr>
                            <?php
                                        $page_lower +=1;
                    ...
                    <div class="pagination pagination-split">
                        ...
                        ?>  
                            <li>
                                <a style="<?=$color?>"  href="<?=SERVER_PATH?>view/manage_blog.php?page=<?=$num?>" ><?=$num?></a>
                            </li>
                        <?php
                                $num+=1;
                            }
