                        ...
                        <tbody>
                            ...
                            ?>
                                     <tr>                                               
                                        ...
                                        <td><?=$arr_value['username']?></td>
                                        <td><?=$arr_value['email_id']?></td>
                                        <td><?=($arr_value['user_type'] == 2) ? "Super Admin" : "Manager" ?></td>
                                        <?php
                                        ...
                                        ?>
                                        <td>
                                            <a href="<?=SERVER_PATH?>view/edit_user.php?id=<?=$arr_value['user_id']?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                                            <a href="#" class="btn btn-danger btn-xs btn_delete" call_link="<?=SERVER_PATH?>controller/controller.php?method=deleteuser-API&id=<?php echo $arr_value['user_id']; ?>" ><i class="fa fa-trash-o"></i> Delete </a>
                                        </td>
                                    </tr>
                            <?php
                                        $page_lower +=1;
