...
class CI_Email {
	...
	var	$smtp_host	 = 'mail.darbarwebs.com';//"ssl://smtp.gmail.com";	 // SMTP Server.  Example: mail.earthlink.net
    var	$smtp_user	 = "test@darbarwebs.com";	 // SMTP Username
    var	$smtp_pass	 = "Test123$";	 // SMTP Password
	*/
    /*
    var	$protocol	 = "smtp";	// mail/sendmail/smtp
	var	$smtp_host	 = "mail.pixelartinfomedia.com";	 // SMTP Server.  Example: mail.earthlink.net
    var	$smtp_user	 = "support@pixelartinfomedia.com";	 // SMTP Username
    var	$smtp_pass	 = "pixelartinfomedia007";	 // SMTP Password
	...
	*/
    ...
    var	$smtp_user	 = "sujit.teccron@gmail.com";//"admin@ecotechz.com";	 // SMTP Username
    var	$smtp_pass	 = "sujit@123";//"Admin123$";	 // SMTP Password
	...
	var $send_multipart	= FALSE;		// TRUE/FALSE - Yahoo does not like multipart alternative, so this is an override.  Set to FALSE for Yahoo.
	...
	function _build_headers()
	{
		...
		$this->_set_header('Mime-Version', '1.0');
               // $this->_set_header('Content-type', 'text/html');
	}       
	...
	function send()
	{
		...
		echo  "email hase no recipientts";	
